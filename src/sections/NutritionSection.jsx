...
const NutritionSection = ({ id }) => {
  ...
  return (
    <section id={id} ref={sectionRef} className="nutrition-section">
      <img src="/images/slider-dip.png" alt="Wave separator" className="w-full object-cover" />
      <img src="/images/big-img.png" alt="SPYLT nutrition display" className="big-img" />

      <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0 gap-10 md:gap-0">
        ...
        <div className="nutrition-box md:pr-20 pr-0 relative">
          <div className="list-wrapper md:flex-row flex-col md:gap-0 gap-6 md:rounded-full rounded-[2rem]">
            {lists.map((nutrient, index) => (
              <div key={nutrient.label} className="nutrient-item relative flex-1 col-center group w-full">
                ...
                {index !== lists.length - 1 && <div className="spacer-border hidden md:block" />}
              </div>
            ))}
          </div>
        </div>
